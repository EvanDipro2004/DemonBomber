...
def update():
    ...
    try:
        ...
        toolVersion = "Demonbomb"

    

    try:

        mainVersion = requests.get("https://raw.githubusercontent.com/Toxic-Noob/DemonBomber/main/more/.version").text
    ...
    os.system("cd .. && rm -rf DemonBomber && git clone https://github.com/Toxic-Noob/DemonBomber > /dev/null 2>&1")
    ...
    os.system("cd .. && cd DemonBomber && python Tbomb.py")
...
def logo():
 ...
 _______   ________  __       __   ______   __    __        _______                                     __                           

/       \ /        |/  \     /  | /      \ /  \  /  |      /       \                                   /  |                          

$$$$$$$  |$$$$$$$$/ $$  \   /$$ |/$$$$$$  |$$  \ $$ |      $$$$$$$  |  ______    ______   _____  ____  $$ |____    ______    ______  
...
$$$$$$$/  $$$$$$$$/ $$/      $$/  $$$$$$/  $$/   $$/       $$$$$$$/   $$$$$$/   $$$$$$$/ $$/  $$/  $$/ $$$$$$$/   $$$$$$$/ $$/       
    ...
    print("\033[94m│ \033[95mAuthor : EvanDipro                 \033[94m│".center(columns+15))

    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))

    print("│ \033[95m \033[94m│".center(columns+9))

    print("│ \033[95mCoder  : Demonic         \033[37mV3.0 \033[94m│".center(columns+15))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mDemonBomber\n")
